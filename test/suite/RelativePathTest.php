...
class RelativePathTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->path = RelativePath::construct(array('.'));
    ...
    public function testConstructorFailureAtomContainingSeparator()
    {
        ...
        RelativePath::construct(array('foo/bar'));
    }
    ...
    {
        $path = RelativePath::fromString($pathString);
    ...
    {
        $path = RelativePath::fromAtoms($atoms, $hasTrailingSeparator);
