...
class RelativeWindowsPathTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $path = RelativeWindowsPath::fromAtoms($atoms, $isAbsolute, $hasTrailingSeparator);
    ...
    {
        $path = RelativeWindowsPath::fromAtoms(array());
    ...
    {
        $path = RelativeWindowsPath::fromDriveAndAtoms($atoms, $drive, $isAbsolute, $hasTrailingSeparator);
    ...
    public function testCreateFromDriveAndAtomsFailureRelativeWithDrive()
    {
        ...
        RelativeWindowsPath::fromDriveAndAtoms(array(), 'C', false);
    }
}
