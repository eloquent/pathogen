...
class AbsoluteWindowsPathTest extends PHPUnit_Framework_TestCase
{
    ...
    public function toRelativeData()
    {
        //                            path           expected
        return array(
            'Single atom'    => array('C:/foo',      'foo'),
            'Multiple atoms' => array('C:/foo/bar',  'foo/bar'),
            'Trailing slash' => array('C:/foo/bar/', 'foo/bar/'),
        );
    }
    ...
    {
        $path = AbsoluteWindowsPath::fromAtoms($atoms, $isAbsolute, $hasTrailingSeparator);
    ...
    {
        $path = AbsoluteWindowsPath::fromAtoms(array());
    ...
    {
        $path = AbsoluteWindowsPath::fromDriveAndAtoms($atoms, $drive, $isAbsolute, $hasTrailingSeparator);
    ...
    public function testCreateFromDriveAndAtomsFailureRelativeWithDrive()
    {
        ...
        AbsoluteWindowsPath::fromDriveAndAtoms(array(), 'C', false);
    }
}
